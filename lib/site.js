...
export const SITE = {
   ...
   */
  about:
    "FenceLine Florida is a professional fence installation company specializing in vinyl and chain-link fencing for residential and commercial properties. We focus on Jacksonville, Orlando, and Kissimmee. As a DBA of Diler Dynamics Group LLC, we provide reliable fencing solutions built for Florida conditions, with permit and HOA documentation available for most jobs.",
  aboutBody:
  ...
  ctaLead:
    "Need residential or commercial vinyl or chain-link fencing in Jacksonville, Orlando, or Kissimmee? Contact FenceLine Florida for a fast, transparent quote.",
