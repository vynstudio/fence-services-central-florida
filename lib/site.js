...
export const SITE = {
  ...
  /**
   * Meta description (~155–160 chars) for SERP + social.
   */
  description:
    "Fence installation & repair in Central Florida. Wood, vinyl, aluminum & chain-link for homes and businesses. Orlando to Jacksonville. Free quote—FenceLine Florida.",
  /**
   * Primary SEO heading (H1-equivalent content on page).
   */
  seoHeading: "Fence Installation & Repair in Central Florida",
  /**
   * Full homepage intro (AEO / on-page).
   */
  about:
  ...
  area: "Central & North Florida · Orlando · Lakeland · Tampa · Jacksonville",
  /** Display order for Areas section (SEO list) */
  serviceAreas: [
    "Orlando",
    "Sanford",
    "Kissimmee",
