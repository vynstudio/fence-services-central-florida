...
export const SITE = {
  ...
  aeoSnippet:
    "FenceLine Florida is a professional fence company serving Central and North Florida, installing wood, vinyl, ornamental aluminum and steel, chain-link, gates, and access control with Florida-weather engineered installs and full permit/HOA handling. Materials from major wholesale lines including Master Halco products where available.",
  ...
  /**
   * NAP — service-area business (no public storefront street yet).
   * When you have a real HQ, set street + postalCode and hasStreetAddress: true.
   */
  ...
  addressLine: "Orlando, FL · Serving Central & North Florida",
  mapsHref:
    "https://www.google.com/maps/search/?api=1&query=Fence+company+Orlando+FL",
  /** Google Business Profile — update when claimed */
  googleBusinessUrl: "https://www.google.com/maps/search/?api=1&query=FenceLine+Florida+Orlando",
