...
/** AEO answer snippets — visible FAQ + FAQPage schema */
export const HOME_FAQS = [
  ...
  {
    q: "Do you repair fences or only install new ones?",
    a: "We install and repair fences—including storm damage restoration, replacements, and gate upgrades—for homes and businesses across Central and North Florida.",
  },
  {
    q: "Who is FenceLine Florida?",
    a: "FenceLine Florida is a professional fence installation and repair company serving Central and North Florida. As a DBA of Diler Dynamics Group LLC, we provide reliable, code-compliant fencing solutions for residential and commercial properties.",
  },
];

/** Full-service offerings (homepage + schema Service list) */
...
export const MATERIAL_SERVICES = [
  {
    title: "Wood fence",
    body: "Privacy and curb appeal with wood systems set for Florida soil and storms.",
  ...
  },
  {
    ...
    body: "Ornamental and pool-ready aluminum with clean lines and long service life.",
    image: "/images/home-gallery-section-3.jpg",
  },
  {
    title: "Chain link",
    body: "Durable security for homes, pets, and commercial lots across the corridor.",
...
export const WHY_POINTS = [
  {
    ...
    body: "Deep-set posts, proper spacing, and durable materials engineered for soil, wind, and storms.",
  },
  {
  ...
  {
    title: "Permits & HOA fully managed",
...
export function getHomeJsonLd() {
  ...
  const organization = {
    ...
    description: `${SITE.about} ${SITE.aboutBody}`,
    url: SITE.url,
    logo: logoUrl,
    image: imageUrl,
    ...
    knowsAbout: [
      ...
      "Aluminum fence",
      "Chain link fence",
      "Storm damage fence restoration",
      "HOA fence approval",
