...
export async function POST(request) {
  try {
    ...
    const lead = {
      ...
      state: clip(body.state, MAX.state) || "FL",
      zip: clip(body.zip, MAX.zip),
      county: clip(body.county, MAX.county),
      formattedAddress: clip(body.formattedAddress, MAX.formattedAddress),
      placeId: clip(body.placeId, MAX.placeId),
